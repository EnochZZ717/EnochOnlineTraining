...
import { IDateTimeOption, IReportRspModel, IAssetRspModel, ICategoryRspModel, ICourseListRspModel, ICourseProgressRspModel, ICourseQueryOption, ICourseReqModel, ICourseRspModel, IPaperReqModel, IPaperRspModel, IQuestionRspModel, ITagRspModel, IReportOverviewRspModel } from "models";
...
const Api = {
  ...
  getCourseReportOverview: (timeRange: IDateTimeOption) => ({method: "POST", url: `course/reports/overview`, body: timeRange} as IFetchProps),
