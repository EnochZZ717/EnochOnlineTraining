...
export const ReportOverview : FunctionComponent<{currentReportOverview: IReportOverviewRspModel | undefined}> 
= ({currentReportOverview}) => { 
  return (
    <>
      ...
      <Row style={{height: '500px'}}>
        <Col>
          <ReportOverviewTable currentReportDates={currentReportOverview?.dateDatas} loading={false} />
        </Col>
      </Row>
    </>    
  );
