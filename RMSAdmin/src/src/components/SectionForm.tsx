...
import { VideoSelect, VideoSelectV2 } from "components";
import { KeywordInput } from "./KeywordInput";
import { VideoForm } from "./VideoForm";

export const SectionForm : FunctionComponent<{currentSection: ISectionModel | undefined, isEdit: boolean, validate: any, confirm: any, isPublished?: boolean}> 
= ({currentSection, isEdit, validate, confirm,isPublished}) => {
  ...
  const handleSectionChange = (sectionModel: ISectionModel) => {
  ...
  return (
    <>
      ...
      >          
        ...
        >
          <Input disabled={isEdit} placeholder="请输入名称" value={sectionModel?.title} onChange ={(val: any) => setSection({ title: val.target.value})}/>
        </Form.Item>
        <Form.Item 
          label={'视频'}
          name="video"
