      ...
      <>
        ...
        <div className='detail-header'>
            ...
            <div className='detail-share'>
                ...
                {!isOperationGuide && <a target='_blank' rel="noreferrer" href='https://app.jingsocial.com/microFrontend/contentCenterH5/center/LNDyn2nwMoQdacMSrVz2EF?appid=wx0fcf5f767046543b&formSurvey=true&tabid=EysMGgfRsyDSSpg7tdxN8H&openid=oXC1AxDlYjnrkEa2dN4RTKXXN_Mc'><Button style={{border: 'none'}} icon={<DownloadOutlined/>}>下载课程</Button></a>}
            </div>
        </div>
