...
export const Login : FunctionComponent = () => {
  ...
  const appId = process.env.REACT_APP_WE_CHAT_CORP_ID;
  const agentId = process.env.REACT_APP_WE_CHAT_AGENT_ID;
  const redirectUri = process.env.REACT_APP_WE_CHAT_REDIRECT_URI;
    ...
    <div className='preview-result' style={{textAlign: 'left'}}>
      <Row>
        <Col style={{textAlign: 'center'}} span={24}>
          <Image alt="logo" preview={false} src={process.env.PUBLIC_URL + '/assets/images/zeiss.png'} height={65} />
        </Col>
      </Row>
      {!scanCodeLogin &&
        <Form
