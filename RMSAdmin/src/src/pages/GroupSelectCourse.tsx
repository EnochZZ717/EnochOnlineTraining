...
import { CourseSearch, CourseSelectedTable, CourseSelectTable, Loading } from 'components';
import { ICourseQueryOption, ICourseRspModel } from 'models';
  ...
  return (
    <>
      ...
      <Row style={{marginTop: 10}}>
        <Col offset={1} span={6}>
          <CourseSearch placeholder='搜索课程' handleRefresh={() => setReloading(true)} />
        </Col>
      </Row>
      <Row style={{marginTop: 10}}>
