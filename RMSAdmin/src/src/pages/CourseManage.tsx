...
import { CourseService, PaperService, SectionNodeService, SectionService } from 'services';
import { Sections,  Paper} from 'pages'
...
export const CourseManage: React.FunctionComponent = () => {
  ...
  const handleSectionSave = (sectionModel: ISectionModel) => {
  ...
  return (
    <>
      ...
      <Row gutter={24}>
        ...
        <Col span={16} style={{marginTop: 5}} >
          <Space style={{float: 'right'}}>
            <Button size='small' hidden={!showCourseCopy()} type="primary" onClick={copyConfirm}>{'复制升级课程'}</Button>
        ...
        <Col span={24}>
          {
            ...
            courseModel?.categoryRootName === CategoryType[0] ?
              <PublicCourseForm 
                ...
                showNodes={() => setShowNodeModal(true)} 
      ...
      </Modal>
      {
        ...
        >
          <VideoForm 
            currentSection={courseModel?.sections[0]}
