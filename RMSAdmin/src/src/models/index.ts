...
export type { ICategoryRspModel, ICategoryReqModel, ISingleCategoryRspModel, ISeriesNumberRspModel, ISeriesNumberReqModel} from './Category';
...
export type { IUserRspModel, IUserReqModel, IUserHistoryRspModel, IUserQueryOption, IUserListRspModel,
  IGroupRspModel, IGroupReqModel, IGroupQueryOption, IGroupListRspModel, IGroupManagerCourseReqModel, IGroupManagerStatusRspModel,IGroupStatusRspModel,
  IUserGroupReqModel, IGroupUserRspModel, IUserGroupRspModel, IGroupManagerReqModel, IGroupManagerRspModel } from './User';
...
export type { IRoleRspModel, IWeChatSimpleUserModel, IWeChatUserModel, IEnterpriseUserRspModel, IEnterpriseUserReqModel, IUserRoleReqModel, IWeChatDepartmentRspModel, IWeChatSignatureModel, IEnterpriseContactModel, IWeChatMessageModel, IWeChatMessageResponseModel } from './Manager'